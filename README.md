...
The associated bipolar Decay CV input and attenuverter knob can modulate the decay length. Both the slider and the CV respond exponentially. The effective decay length ratio is clamped to a value between 1/64 and 16.
...
The associated bipolar Frequency CV input and attenuverter knob can modulate the frequency ratio. Both the slider and CV respond exponentially. The effective frequency ratio is clamped to a value between 1 and 256.
